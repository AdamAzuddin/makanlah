  ...
  const ecoRestaurants = [
    {
      ...
      imgPath: "/restaurant_1.png",
    },
    {
      name: "Sustain Kitchen",
      description: "Sustainable dining experience",
      imgPath: "/restaurant_2.png",
    },
    {
      name: "Verdant Bites",
      description: "Green menu options",
      imgPath: "/restaurant_3.png",
    },
  ];
